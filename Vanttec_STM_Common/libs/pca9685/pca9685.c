...
{
	handle->device_address = handle->device_address << 1;
	...
	success &= pca9685_set_prescaler(handle, 3);
...
bool pca9685_set_prescaler(pca9685_handle_t *handle, uint8_t prescaler)
{
	bool success = true;
