...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, blue_light_pin_Pin|GPIO_PIN_9|green_light_pin_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : blue_light_pin_Pin PA9 green_light_pin_Pin */
  GPIO_InitStruct.Pin = blue_light_pin_Pin|GPIO_PIN_9|green_light_pin_Pin;
